...
features1 = [single,group,conference,wifi,coffee,monitor]
...
space1.features = [single, group, conference, wifi, coffee, monitor]
space2.features = [single, conference, wifi]
space3.features = [conference, wifi]
space4.features = [single, wifi, coffee]
space5.features = [single, group, conference, wifi, coffee, monitor]
