...
Space.all.each{|space| space.update(slug: space.name.parameterize)}
...
features2 = [single,conference,wifi]
features3 = [conference, wifi]
features4 = [single,wifi,coffee]
features5 = [single,group,conference,wifi]
features6 = [single,wifi,monitor]
features7 = [single,group,wifi]
...
spaces = [
    ...
    #     "city": null,
    #     "map": {
    #         "address": "17250 Dallas Pkwy, Dallas, TX, USA",
    #         "lat": "32.9853004",
    #         "lng": "-96.82764680000002"
    #     },
    #     "name": "CityCentral",
    #     "slug": "citycentral-2"
    # },
    ...
    #     "city": null,
    #     "map": {
    #         "address": "6010 W Spring Creek Pkwy, Plano, TX, USA",
    #         "lat": "33.0639381",
    #         "lng": "-96.83049399999999"
    #     },
    #     "name": "CityCentral",
    #     "slug": "citycentral"
    # },
    ...
    #     "city": null,
    #     "map": {
    #         "address": "7500 Monterey Street,
    #         Gilroy, CA 95020",
    #         "lat": "37.0057816",
    #         "lng": "-121.5682751"
    #     },
    #     "name": "Coworking in the South Bay - Gilroy CA",
    #     "slug": "coworking-south-bay-gilroy-ca"
    # },
    # {
    #     "ID": 15268,
    #     "city": null,
    #     "map": {
    #         "address": "11 Garfield Place, Cincinnati, OH, USA",
    #         "lat": "39.1041773",
    #         "lng": "-84.51439499999998"
    #     },
    #     "name": "1628 Ltd.",
    #     "slug": "1628-ltd"
    # },
...
#         # byebug
#         response = RestClient.get(url_to_fetch, {"Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvY293b3JraW5nbWFwLm9yZyIsImlhdCI6MTU1MTMxMzMzMiwibmJmIjoxNTUxMzEzMzMyLCJleHAiOjE1NTE5MTgxMzIsImRhdGEiOnsidXNlciI6eyJpZCI6IjI4MDIifX19.2IaRLZmt_sF7sVs7qfrKVs97vlAlPfgo8qLDYQ6Lb2A"})
#         space_details = JSON.parse(response.body)

#         address_data = Geocoder.search([@space.lat,@space.long]).first

#         @space.update(
#             state: address_data.state,
#             zip: address_data.postal_code.to_i,
#             description: space_details["description"].gsub(/<br\s*\/?>/, ''),
#             img_url: space_details["cover-photo"]
#         )
#         @space.save
#         puts "SEEDED: id: #{@space.api_id}, space: #{@space.name}"
#     end
